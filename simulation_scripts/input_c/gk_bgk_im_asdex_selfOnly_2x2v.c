// Input script produced by D. Liu (01/08/2025)
#include <math.h>
#include <stdio.h>
#include <time.h>
...
main(int argc, char **argv)
{
  ...
  struct gkyl_gyrokinetic_species elc = {
    ...
    .num_diag_moments = 9,
    .diag_moments = { "M0", "M1", "M2", "M2par", "M2perp", "M3par", "M3perp", "BiMaxwellianMoments", "MaxwellianMoments" },
  };
  ...
  // GK app
  struct gkyl_gk gk = {
    .name = "gk_bgk_im_asdex_selfOnly_2x2v_p1",
